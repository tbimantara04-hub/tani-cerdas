...
class AgentOrchestrator:
    ...
    def _execute_agent_action(self, agent: Any, action: str, params: Dict[str, Any], 
        ...
        if action == "create_plan" and hasattr(agent, "create_planting_plan"):
            return agent.create_planting_plan(**params)
        elif action == "check" and hasattr(agent, "process_query"):
            return agent.process_query(params.get("query", ""), {"farmer_id": context.farmer_id})
        elif action == "get_guidance" and hasattr(agent, "search_by_topic"):
            return agent.search_by_topic(params.get("topic", ""))
        elif action == "get_forecast" and hasattr(agent, "get_price_forecast"):
            return agent.get_price_forecast(**params)
